...
audio_video_packages=(
  audacity ffmpeg handbrake kdenlive obs-studio simplescreenrecorder vlc video-trimmer mpv
)
...
development_packages=(
  neovim git lazygit nodejs emacs tree
)
...
bash-completion bat ddgr dconf-editor fish ripgrep fd fzf font-manager galculator gparted gnome-disk-utility hardinfo2 man-db man-pages fastfetch tlp xorg-xkill zsh zsh-completions zsh-syntax-highlighting
)
