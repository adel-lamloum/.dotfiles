;;; 2bit-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
(fn FILE SEQUENCE START END)" t)
(register-definition-prefixes "2bit" '("2bit-"))

;;; End of scraped data

(provide '2bit-autoloads)
